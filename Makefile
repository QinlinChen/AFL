...
ifndef AFL_TRACE_PC
	...
	if [ -f hook-llvm-rt.o ]; then set -e; install -m 755 hook-llvm-rt.o $${DESTDIR}$(HELPER_PATH); fi
	if [ -f hook-llvm-rt-32.o ]; then set -e; install -m 755 hook-llvm-rt-32.o $${DESTDIR}$(HELPER_PATH); fi
	if [ -f hook-llvm-rt-64.o ]; then set -e; install -m 755 hook-llvm-rt-64.o $${DESTDIR}$(HELPER_PATH); fi
